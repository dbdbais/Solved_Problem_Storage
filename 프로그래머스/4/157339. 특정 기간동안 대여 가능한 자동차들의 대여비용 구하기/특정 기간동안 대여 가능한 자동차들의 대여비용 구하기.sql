SELECT CC.car_id, CC.car_type, ROUND(DAILY_FEE * 30 * (100-DISCOUNT_RATE)/100) as `FEE` from CAR_RENTAL_COMPANY_CAR CC NATURAL JOIN CAR_RENTAL_COMPANY_RENTAL_HISTORY RR 
